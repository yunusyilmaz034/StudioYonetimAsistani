...
## PF-11 — Egzersiz kütüphanesi: form görselleri + hareket rehberi (kas grupları, ipuçları, sık hatalar) · `backlog`
...
## PF-12 — Tema / Görünüm ayarları: dinamik renk paleti + font + font-size (Ayarlar › Tema) · `backlog`
...
## PF-13 — Takvim seans hücrelerini renklendir (ders tipi / durum bazlı background) · `backlog`
...
## PF-14 — Ürün Sat dialogunda kasa seçici yok → nakit/POS satış hep başarısız (BUG) · `backlog`
...
## PF-15 — Kasa düzenleme (yeniden adlandır / sil) yok · `backlog`
...
**Fix:** Kasa satırına düzenle (ad) + pasife al/sil (hareketi yoksa sil, varsa pasife al) ekle. Düşük risk, küçük iş.

---

## PF-16 — Toast mesajları sağ-alttan → daha görünür konum · `backlog`
...
## PF-17 — Toplu Gönderim'de mail başarısız ("0 gönderildi, 1 başarısız") · `backlog`
