...
export default function Home() {
  ...
  // The next day the studio is actually open, and what runs on it. A member with nothing booked was
  // being handed an empty page and the instruction to go and look somewhere else ("anasayfa boş
  // kaldı"); the timetable is the thing she would have gone to look at. Four rows at most — this is
  // a glance, and Ajanda is one tap away for the rest.
  ...
  return (
    <Screen refreshControl={<RefreshControl refreshing={dash.loading} onRefresh={() => { void dash.reload(); void inbox.reload(); void home.reload(); void fitness.reload(); void agenda.reload() }} tintColor={p.accent} />}>
