...
import { CheckIcon, DoorOpenIcon, Loader2Icon, PlusIcon, UserIcon, UsersIcon, XIcon } from 'lucide-react'
...
function AddPastMember({ session, onAdded }: { session: CalendarSession; onAdded: () => void }) {
  const [open, setOpen] = useState(false)
  const [query, setQuery] = useState('')
