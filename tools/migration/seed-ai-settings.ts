...
const AI = {
  ...
  faq: [
    ...
    { q: 'Nakit ödesem daha mı ucuz? / Nakit fiyatınız farklı mı?', a: 'Hayır, fiyatımız tek. Nakit, havale ve kredi kartında aynı tutarı ödersiniz — nakde özel ayrı bir liste yoktur.' },
    { q: 'Taksit yapabilir miyim? / Nakitte taksit var mı?', a: 'Kredi kartına taksit yapabilirsiniz; ödeme adımında kartınızın desteklediği seçenekler listelenir. Taksit seçeneğine göre vade farkı oluşabilir — bunu bankanız/ödeme altyapısı belirler, stüdyo bir fark eklemez. Nakit ve havalede taksit yoktur.' },
